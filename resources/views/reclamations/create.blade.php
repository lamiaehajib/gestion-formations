...
<div class="hero-section">
    <div class="container">
        <div class="hero-content text-center">
            ...
            <p class="lead mb-0">Faites entendre votre voix - Votre satisfaction est notre priorité</p>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            {{-- Affichage des erreurs de validation (déjà présent et correct) --}}
            @if ($errors->any())
                    ...
                    <form action="{{ route('reclamations.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="category-grid">
                                {{-- Utilisation des catégories définies dans le modèle Reclamation (App\Models\Reclamation::CATEGORIES) --}}
                                @foreach(App\Models\Reclamation::CATEGORIES as $key => $label)
                                    <div class="category-option">
                                        ...
                                        <label for="category_{{ $key }}">
                                            {{-- Ajustement des icônes pour correspondre aux catégories --}}
                                            <i class="fas fa-{{
                                                $key == 'technique' ? 'cog' : (
                        ...
                        <div class="form-group">
                            ...
                            <div class="priority-pills">
                                {{-- Utilisation des priorités définies dans le modèle Reclamation (App\Models\Reclamation::PRIORITIES) --}}
                                @foreach(App\Models\Reclamation::PRIORITIES as $key => $label)
                                    <div class="priority-pill">
                                        ...
                                        <label for="priority_{{ $key }}">
                                            {{-- Ajustement des icônes pour correspondre aux priorités --}}
                                            <i class="fas fa-{{
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Form validation enhancement (show loading on submit)

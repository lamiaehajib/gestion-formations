...
<head>
    ...
    <style>
        ...
        .heading { color: #ef4444; font-size: 28px; margin-top: 0; }
        ...
        <tr>
            <td>
                ...
                <table class="content" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            <h1 class="heading">Bienvenue, {{ $user->name }} !</h1>
                            <p>
                                L'administration de UITS a créé votre compte sur notre application. Vous pouvez vous connecter en utilisant les identifiants ci-dessous :
                            </p>
                            <div class="details-box">
                                <p><strong>Email :</strong> {{ $user->email }}</p>
                                <p><strong>Mot de passe temporaire :</strong> <span style="color:#C2185B;">{{ $password }}</span></p>
                            </div>
                            <p>
